...
CITS 3D HM does not change or extend any of the requirements for the Representation root element, but particular notice is drawn to the specific requirements of a Representation METS root element and the specific content type attributes to be used in CITS 3D HM.
